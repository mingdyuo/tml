...
| 장   | 내용                                  | 읽기               | 정리 |
| ---- | ------------------------------------- | ------------------ | ---- |
| 2장  | 동시성과 병렬성의 차이                | :white_check_mark: |      |
|      | CSP란 무엇인가?                       | :white_check_mark: |      |
|      | 동시성을 지원하는 언어의 장점         | :white_check_mark: |      |
|      | Go의 동시성에 대한 철학               | :white_check_mark: |      |
| 3장  | 고루틴                                | :white_check_mark: |      |
|      | Sync 패키지                           | :white_check_mark: |      |
|      | 채널                                  |                    |      |
|      | select 구문                           |                    |      |
|      | GOMAXPROCS 레버                       |                    |      |
|      | 결론                                  |                    |      |
